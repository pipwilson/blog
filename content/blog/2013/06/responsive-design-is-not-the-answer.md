---
title: "Responsive design is not the answer"
slug: responsive-design-is-not-the-answer
date: 2013-06-28 14:25:03
taxonomies:
  tags:
    - communication
  collections:
...
> Over 100 people in the responsive design session at [#iwmw13](https://twitter.com/search?q=%23IWMW13). Question "who's cynical about responsive design?" - **no** hands go up.

Universities tend to be a bit behind the curve when it comes to deploying new technologies, which is why responsive design is still so thin on the ground and celebrated [when it does actually happen](http://weedygarden.net/highered-rwd-directory/) (just the same as other big organisations). But not being able to see the problems it gives you is a real worry.
...
If we can standardise the page types we have on our site, in the way that [Government Digital Service have done with the content on gov.uk](https://www.gov.uk/designprinciples/mainstream), then we stand a real chance of helping those editors in their daily jobs by making it clearer what the expectations of them are, as well as giving us much more flexibility in presenting the right content for the right people on the right device at the right time.
...
[![](http://api.tweetmeme.com/imagebutton.gif?url=http%3A%2F%2Fblogs.bath.ac.uk%2Fwebservices%2F2013%2F06%2F28%2Fresponsive-design-is-not-the-answer%2F)](http://api.tweetmeme.com/share?url=http%3A%2F%2Fblogs.bath.ac.uk%2Fwebservices%2F2013%2F06%2F28%2Fresponsive-design-is-not-the-answer%2F)
