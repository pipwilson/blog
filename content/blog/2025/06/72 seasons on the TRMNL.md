...
You can [access the source code here](https://github.com/pipwilson/trmnl-72-seasons), and if you have a TRMNL device you should soon be able to find it on the list of Recipes on their website.
