...
[Zola Blog Editor](https://github.com/pipwilson/zola-blog-editor) is a desktop and mobile application for posting to your [Zola](https://www.getzola.org/) blog when the content is stored in GitHub.

On my Android e-ink tablet it looks like this:

![A screenshot of Zola Blog Editor running on an Android tablet](/images/2026/06/zola-blog-editor-2026-06-09.png)

It uses [Tauri](https://tauri.app/) to wrap a web applicaton which connects to the GitHub API to retrieve, edit and add content. This means it requires a network connection to work since it is a remote-first tool.
